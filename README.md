...
A Flutter Shared_preference Example with simple working and understanding for beginers. Fork or clone the project and run for understanding the working of shared_preference.
...
I kept the code as original as possible with proper Commented Guides for anyone to understand and implement. Still you need to follow these steps.
  ...
  - Now download this [Repo](https://github.com/jinosh05/shared_preference_example_flutter/archive/refs/heads/master.zip)
  - Extract the Repo into your newly created **shared_preference_example_flutter** and replace the required files.
